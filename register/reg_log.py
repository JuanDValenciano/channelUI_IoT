...
class file(object):
        ...
        def ThingSpeak(self,KEY,d1,d2,d3,d4,Temp_CPU,Temp_CPU2):
            params = urllib.urlencode( {'field1':d1,'field2':d2,'field3':d3,'field4':d4,'field5':Temp_CPU, 'field6':Temp_CPU2,'api_key':KEY})
